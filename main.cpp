...
int main()
{
    int x; /* variable del numero del 0 al 999 que se va a solicitar*/
    cout<<"BUENAS!!! Por favor ingrese un numero del 0 al 999: "<<endl; /*Inicio del programa con el ususario*/
    cin>>x; /* ingreso de la variable por el ususario*/
if((x<1)||(x>999)) cout<<"ERROR!!!!        POR FAVOR INGRESA UN NUMERO DEL 1 AL 999\n"; /* mensaje de error al digitar un numero no aceptado*/
else
 /* por medio de comando if ir dando nombre a los numeros segun su posicion de 100 en 100*/
    {cout <<"Su número es: ";}{
        ...
        /* por medio de comando if ir dando nombre a los numeros segun su posicion de 10 en 10*/
        if(x>90) {cout<<"NOVENTA Y "   ;x=x-90; }
         ...
         /* por medio de comando if ir dando nombre a los numeros segun su posicion de 1 en 1*/
